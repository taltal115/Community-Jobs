...
var getUniqueErrorMessage = function (err) {
  ...
  try {
    ...
    var begin = err.errmsg.indexOf('.');
    var end = err.errmsg.indexOf(' ', begin);
    var model = err.errmsg.substring(begin + 1,end - 1);
    output = model.charAt(0).toUpperCase() + model.slice(1) + ' already exists';
